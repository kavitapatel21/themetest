...
class WooCommerce
{
    ...
    public function getBarcodes()
    {
        ...
        $post = array();
        foreach (array('format', 'withVariations', 'isImportSingleVariation', 'isUseApi', 'lineSeparator1', 'lineSeparator2', 'lineSeparator3', 'lineSeparator4', 'page') as $key) {
            if (isset($_POST[$key])) {
    ...
    public function getBarcodesByOrders()
    {
        Request::ajaxRequestAccess();
        $post = array();
        foreach (array('format', 'orderQuantity', 'useStockQuantity', 'isUseApi', 'lineSeparator1', 'lineSeparator2', 'lineSeparator3', 'lineSeparator4') as $key) {
            if (isset($_POST[$key])) {
                $post[$key] = sanitize_text_field($_POST[$key]);
            }
        }
