        ...
        switch ($algorithm) {
            case 'EAN8': 
                ...
                if (!$validData['is_valid']) {
                    $msg = __("%field% field contains incorrect data. It must contain 8 digits. 7 digits and 8th is a checksum digit calculated by formula. Check more on <a target='_blank' href='https://en.wikipedia.org/wiki/EAN-8'>Wiki</a>.", 'wpbcu-barcode-generator');
                    $validData['message'] = str_replace('%field%', $field, $msg);
                }
                break;
            case 'EAN13': 
                ...
                if (!$validData['is_valid']) {
                    $msg = __("%field% field contains incorrect data. It must contain 13 digits. 12 digits and 13th is a checksum digit calculated by formula. Check more on <a target='_blank' href='https://en.wikipedia.org/wiki/International_Article_Number'>Wiki</a>.", 'wpbcu-barcode-generator');
                    $validData['message'] = str_replace('%field%', $field, $msg);
                }
                break;
            case 'UPCA': 
                ...
                if (!$validData['is_valid']) {
                    $msg = __("%field% field contains incorrect data. It must contain 12 digits. 11 digits and 12th is a checksum digit calculated by formula. Check more on <a target='_blank' href='https://en.wikipedia.org/wiki/Universal_Product_Code'>Wiki</a>.", 'wpbcu-barcode-generator');
                    $validData['message'] = str_replace('%field%', $field, $msg);
                }
                break;
            case 'UPCE': 
                ...
                if (!$validData['is_valid']) {
                    $msg = __("%field% field contains incorrect data. It must contain 6 digits. UPC-E is a variation of UPC-A which allows for a more compact barcode by eliminating 'extra' zeros. Check more on <a target='_blank' href='https://en.wikipedia.org/wiki/Universal_Product_Code#UPC-E'>Wiki</a>.", 'wpbcu-barcode-generator');
                    $validData['message'] = str_replace('%field%', $field, $msg);
                }
                break;
            case 'C128': 
                ...
                if (!$validData['is_valid']) {
                    $msg = __("%field% field contains incorrect data. Code 128 supports alphanumeric or numeric-only barcodes. It can encode all 128 characters of ASCII encoding.", 'wpbcu-barcode-generator');
                    $validData['message'] = str_replace('%field%', $field, $msg);
                }
                break;
            case 'C39': 
                ...
                if (false == preg_match($patern, $code)) {
                    $validData['is_valid'] = false;
                    $msg = __("%field% field contains incorrect data. Code 39 supports 43 characters, consisting of letters (A-Z), numeric digits (0 through 9) and a number of special characters (-, ., $, /, +, %, and space).", 'wpbcu-barcode-generator');
                    $validData['message'] = str_replace('%field%', $field, $msg);
                }
                break;
            case 'QRCODE': 
